            ...
            'hello-widget': {
                component: ({ widgetData: e = {}, widgetId: t = null }) => {
                    const n = rr.useMemo(() => {
                        ...
                        return (
                            e.heading_color &&
                                (r['--hello-heading-color'] = e.heading_color),
                            e.heading_font_size &&
        ...
        _r = U({}, xn, {
            ...
            movementX: function (e) {
                return 'movementX' in e
                    ...
                    : (e !== Nn &&
                          (Nn && e.type === 'mousemove'
                              ? ((iu = e.screenX - Nn.screenX),
                                (su = e.screenY - Nn.screenY))
                              : (su = iu = 0),
                          (Nn = e)),
                      iu);
            },
...
`
    ...
    function Ns(e, t, n) {
        ...
        r = r.getChildContext();
        for (var l in r)
            if (!(l in t)) throw Error(v(108, Dc(e) || 'Unknown', l));
        return U({}, n, r);
    }
    function Mr(e) {
        return (
    ...
    function Ds(e) {
        ...
        function p(f, a, d, y) {
            ...
            if (typeof d == 'object' && d !== null) {
                ...
                if (dn(d) || cn(d))
                    return E !== null ? null : m(f, a, d, y, null);
                Ur(f, d);
            }
            return null;
        }
            ...
            if (
                ...
                try {
                    var o = t.lastRenderedState,
                        i = u(o, n);
                    if (
                        ((l.hasEagerState = !0), (l.eagerState = i), Ne(i, o))
                    ) {
                        var s = t.interleaved;
                        (s === null
                            ? ((l.next = l), $u(t))
    ...
    function eo(e, t, n, r) {
        ...
        (typeof u == 'object' && u !== null
            ...
            typeof u == 'function' &&
                (bu(e, t, u, n), (l.state = e.memoizedState)),
...
` +
    ...
    function lo(e, t, n, r, l, u) {
        ...
        return (
            (t.flags |= 1),
            e !== null && o
                ? ((t.child = qt(t, e.child, null, u)),
                  (t.child = qt(t, null, i, u)))
                : oe(e, t, i, u),
    ...
    function dd(e, t, n) {
        ...
        switch ((Ru(t), t.tag)) {
            ...
            case 13:
                if (
                    ...
                    if (j && ye !== null && t.mode & 1 && !(t.flags & 128))
                        ...
                        ((u = jr(t)), r !== null && r.dehydrated !== null)
                    ) {
                        if (e === null) {
            ...
            case 17:
                return (ae(t.type) && Or(), ne(t), null);
            case 19:
                if ((F($), (u = t.memoizedState), u === null))
                    return (ne(t), null);
                if (
                    ((r = (t.flags & 128) !== 0), (o = u.rendering), o === null)
                )
                    if (r) Qn(u, !1);
                    else {
    ...
    function on() {
        if (ft !== null) {
            ...
            try {
                if (
                    ((_e.transition = null), (O = 16 > e ? 16 : e), ft === null)
                )
                    var r = !1;
                else {
                    if (((e = ft), (ft = null), (ll = 0), R & 6))
                        throw Error(v(331));
                    var l = R;
    ...
    dl.prototype.unstable_scheduleHydration = function (e) {
        if (e) {
            ...
            for (
                var n = 0;
                n < et.length && t !== 0 && t < et[n].priority;
                n++
            );
    ...
    const vl = (e) => (t) => {
            ...
            const n = `.${e}-wrapper`,
                ...
                l =
                    t.find(n)[0] ||
                    ((h = t[0]) == null ? void 0 : h.querySelector(n)),
            ...
            let o =
                ((p = l == null ? void 0 : l.dataset) == null
                    ? void 0
                    : p.widgetId) ||
                t.data('id') ||
                t.data('widget-id');
        ...
        jd = () => {
            ...
            ((n = e.contentDocument) == null ? void 0 : n.readyState) ===
            'complete'
                ? t()
